...
_TERMINAL_PROVIDER_SAFETY_DETAIL = "Ideogram 4 safety filter blocked all provider caption variants"
_SAFETY_DETAILS = frozenset({_SINGLE_IMAGE_SAFETY_DETAIL, _LEGACY_SAFETY_DETAIL})
_TERMINAL_SAFETY_DETAILS = frozenset({*_SAFETY_DETAILS, _TERMINAL_PROVIDER_SAFETY_DETAIL})
...
def is_terminal_safety_rejection_detail(detail: str) -> bool:
    """Return whether Ideogram has terminally rejected an image for safety."""
