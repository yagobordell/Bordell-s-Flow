...
$AutoscalerControl = Join-Path $PSScriptRoot "../salad/restore_salad_scale_to_zero.ps1"
...
$ManifestInspector = Join-Path $PSScriptRoot "../diagnostics/inspect_phase8_manifest.py"
