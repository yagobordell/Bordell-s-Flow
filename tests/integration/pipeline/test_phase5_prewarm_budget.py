...
PHASE5_CONTROLLED = Path("scripts/pipeline/run_phase5_audio_controlled.ps1")
...
PHASE5_ALIGNMENT_CONTROLLED = Path("scripts/pipeline/run_phase5_alignment_controlled.ps1")
