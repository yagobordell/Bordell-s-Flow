...
import ai_video_factory.workers.flux2_klein.bootstrap_watchdog as bootstrap_watchdog
...
def test_flux2_klein_bootstrap_watchdog_accepts_worker_ready(tmp_path: Path) -> None:
...
def test_flux2_klein_bootstrap_watchdog_reallocates_stalled_stage(
    tmp_path: Path,
