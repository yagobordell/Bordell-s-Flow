...
Historical Phase 8 validation evidence and closure notes are preserved in Git history. The active
production contract is documented here and in the [architecture overview](../architecture/overview.md).
