...
```powershell
pwsh scripts/salad/manage_salad_stack.ps1 `
  -Action Prepare `
...
```powershell
pwsh scripts/salad/manage_salad_stack.ps1 -Action Prepare -SkipBuild
```
...
pwsh scripts/salad/manage_salad_worker.ps1 -Service ideogram4 -Action Start
pwsh scripts/salad/manage_salad_worker.ps1 -Service ideogram4 -Action Status
pwsh scripts/salad/manage_salad_worker.ps1 -Service ideogram4 -Action Stop
```
